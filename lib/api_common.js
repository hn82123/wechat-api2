 ...
 */
var API = function (appid, appsecret, getToken, saveToken, isWXCloud = false) {
  this.isWXCloud = isWXCloud;
  this.appid = appid;
  ...
  var tls = (isWXCloud) ? 'http' : 'https';
  this.endpoint = tls + '://api.weixin.qq.com';
  this.mpPrefix = tls + '://mp.weixin.qq.com/cgi-bin/';
...
API.prototype.setEndpoint = function (domain) {
  var tls = (this.isWXCloud) ? 'http' : 'https';
  this.endpoint = tls + '://' + domain;
};
